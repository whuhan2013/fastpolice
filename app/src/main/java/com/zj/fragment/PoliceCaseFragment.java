...
import com.zj.fastpolice.CaseDetailActivity;
...
public class PoliceCaseFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
            ...
            public void run() {
                ...
                try {
                    ...
                    int editor=fastPoliceApplication.getRole();
                        ...
                        caseList = NetUtils.getListByID(queryByPoliceID);
        ...
        public View getView(final int i, View convertView, ViewGroup viewGroup) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    bundle.putSerializable("casedetial",caseList.get(i));
                     intent.putExtra("mycase",bundle);
